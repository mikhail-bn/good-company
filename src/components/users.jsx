        ...
        <>
            <h2>
                <span
                    ...
                    {users.length > 0 ? `Are you ready for the party? The ${users.length} of us ${users.length > 1 ? "are" : "is"}  waiting for you` : "You've got rid all of them"}
                </span>
            </h2>
                        ...
                        users.map((user) => {                            
                            return (                               
                                <tr key={user._id}>                                 
                                    ...
                                    <td>{user.rate}</td>                              
                                    <td><button className="btn btn-danger" onClick={() => handleDelete(user._id)}>Get rid of</button></td>                              
                                </tr>  
                            )
                        })
                    }                            
